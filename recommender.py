...
def get_recommendations(movie_id, list_number):
    if list_number:
        if list_number == 1:
            ...
            return get_recommendation_list_6(movie_id)

    return [get_recommendation_list_1(movie_id)['List'], get_recommendation_list_2(movie_id)['List'],
            get_recommendation_list_3(movie_id)['List'], get_recommendation_list_4(movie_id)['List'],
            get_recommendation_list_5(movie_id)['List'], get_recommendation_list_6(movie_id)['List']]
